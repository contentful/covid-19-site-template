...
function resolveCountryNodes(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var pluginOptions, apiClient, nodeKit, createNode, countries, promises;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pluginOptions = ctx.pluginOptions, apiClient = ctx.apiClient, nodeKit = ctx.nodeKit;
                    createNode = nodeKit.actions.createNode;
                    countries = pluginOptions.countries || [];
                    promises = countries.map(function (_a) {
                        var iso2 = _a.iso2;
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 3:
                                        ...
                                        node = toCountrySummaryNode(nodeKit, iso2, result);
                                        createNode(node);
                                        return [2 /*return*/];
                                }
                            });
...
exports.default = resolveCountryNodes;
